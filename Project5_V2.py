...
print("Probability of wins with switching:",round(count_wins_with_switching/simlations,4))
print("Percentage of wins without switching:",round((count_wins_without_switching/simlations)*100,0),"%")
print("Percentage of wins with switching:",round((count_wins_with_switching/simlations)*100,0),"%")
